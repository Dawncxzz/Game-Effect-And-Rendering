...
public class CutsceneVolume : VolumeComponent, IPostProcessComponent
{
    ...
    public ClampedFloatParameter _FLIPOVER_Progress = new ClampedFloatParameter(0, 0, 1);

    [Header("灰度")]
    public ClampedFloatParameter _GRAYSCALE_Value = new ClampedFloatParameter(0, 0, 1);
